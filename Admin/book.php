...
<div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h4 style="text-align: center; font-size: 30px; " class="card-title">Add Booking </h4>
                            <form method="post" >
                                ...
                                <div class="row">
                                    ...
                                    <input style="text-align: center;justify-content: center;align-items: center; " type="submit" class="btn btn-primary" name="btnregister" value="Add Child" ></input>
                                </div>
                                </div>
