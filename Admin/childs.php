    ...
    <div class="main-wrapper">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="javascript:void(0);"><i class="fa fa-hospital-o"></i> <span>CHILD DETAILS</span></a>
                        </li>
						<li >
        ...
        <div class="page-wrapper">
            <div class="content">
               ...
               <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 style="text-align: center;" class="page-title">All CHILD DETAILS</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
     ...
     foreach($result as $row){
        ...
        // echo"<td>$row[gender]</td>";
         echo"<td>
         <a href='childprofile.php?id=$row[child_id]&pid=$row[parent_id]&name=$row[name]&date=$row[date_of_birth]&gender=$row[gender]'>VIEW PROFILE</a></td>";
