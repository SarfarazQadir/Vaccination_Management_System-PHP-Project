...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
               ...
               <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 style="text-align: center;" class="page-title">All HOSPITAL DETAILS</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="card-block">
								<div class="table-responsive">
									<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12"><table class="datatable table table-stripped dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                    <thead>
                                    <tr>
        <th>ID</th>
        <th>NAME</th>
      ...
      foreach($result as $row){
          ...
          echo"<td>$row[hospital_password]</td>";
          echo"<td>$row[hospital_email]</td>";
          echo"<td>$row[hospital_contact]</td>";
          echo"<td>$row[hospital_address]</td>";
          echo"<td>$row[hospital_location]</td>";
          echo"<td>$row[status]</td>";
          echo"<td>
          <a style='cursor: pointer;' class='dropdown-item' href='deletehospital.php?id=$row[hospital_id]' data-toggle='modal' data-target='#delete_doctor'><i class='fa fa-trash-o m-r-5'></i> Delete</a>
          ";
          echo"<td>
          <a href='updatehospital.php?id=$row[hospital_id]&name=$row[hospital_name]&username=$row[hospital_username]&password=$row[hospital_password]&email=$row[hospital_email]&contact=$row[hospital_contact]&address=$row[hospital_address]&location=$row[hospital_location]'''class='update'>UPDATE</a>
          </td>";
          echo"<td>";
          if($row['status']== "Reject"){
            echo "<a href='approvehospital.php?id=$row[hospital_id]'class='approve'>APPROVE</a></td>";
          }else{
            echo "<a href='rejecthospital.php?id=$row[hospital_id]'class='reject'>REJECT</a></td>";
          }
          "</td>;
          echo</tr>";
      };
				...
				<div class="modal-content">
					<div class="modal-body text-center">
                        ...
                        echo " 	<div class='m-t-20'> <a href='#' class='btn btn-white' data-dismiss='modal'>Close</a>
							<a  href='deletehospital.php?id=$row[hospital_id]'><button type='submit' class='btn btn-danger'>Delete</button></a>
						</div>"
                        ?>
					</div>
				</div>
