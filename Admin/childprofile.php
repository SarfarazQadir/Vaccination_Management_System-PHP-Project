        ...
        <div class="page-wrapper">
            <div class="content">
               ...
               <!-- ALL CHILD PROFILE DETAILS -->
                ...
                ?>
                <ul>
                    <li>CHILD ID :  <?php echo $id ?></li>
                    <li>PARENT ID :  <?php echo $pid ?></li>
                    <li>CHILD NAME :  <?php echo $name ?></li>
                    <li>CHILD DATE OF BIRTH :  <?php echo $birth ?></li>
                    <li>CHILD GENDER :  <?php echo $gender ?></li>
                </ul>
                </div>

               <!-- CLOSE ALL CHILD PROFILE DETAILS -->
