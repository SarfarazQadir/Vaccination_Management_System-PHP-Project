...
<div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h4 style="text-align: center; font-size: 30px; " class="card-title">Add Child Details </h4>
                            <form method="post" >
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" required="" name="txtpwd" class="form-control">
                                        </div>
                                    ...
                                    <input style="text-align: center;justify-content: center;align-items: center; " required="" type="submit" class="btn btn-primary" name="btnregister" value="Add Child" ></input>
                                </div>
                                </div>
