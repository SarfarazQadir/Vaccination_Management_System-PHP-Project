                                                ...
                                                <table class="datatable table table-stripped dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($result as $row) {
                                                            ...
                                                            echo "<td>";
                                                            if ($row['b_status'] == "Reject") {
                                                                echo "<a href='approvebookings.php?id=$row[booking_id]'class='approve'>APPROVE</a></td>";
                                                            } else {
                                                                echo "<a href='rejectbookings.php?id=$row[booking_id]'class='reject'>REJECT</a></td>";
                                                            }
                                                            "</td>;
         echo</tr>";
                                                        };
