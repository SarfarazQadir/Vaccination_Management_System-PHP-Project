...
<body>
    <div class="main-wrapper">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="javascript:void(0);"><i class="fa fa-user"></i> <span>PARENTS</span></a>
                        </li>
                        <li>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 style="text-align: center;padding-bottom: 40px;padding-left: 80px;" class="page-title">PARENTS DETAILS</h4>
                    </div>
      ...
      foreach($result as $row){
          ...
          echo"<td>$row[parent_password]</td>";
          echo"<td>$row[parent_email]</td>";
          echo"<td>$row[parent_contact]</td>";
          echo"<td>$row[parent_city]</td>";
          echo"<td>$row[status]</td> " ;
        
          echo"<td>";
          if($row['status']== "Reject"){
       
            echo "<a href='approveparents.php?id=$row[parent_id]'class='approve'>APPROVE</a></td>";
          }else{
            echo "<a href='rejectparents.php?id=$row[parent_id]'class='reject'>REJECT</a></td>";
          }
          "</td>";
         
          echo"<td>";
          echo"<div class='dropdown dropdown-action'>
          <a class='dropdown-item' href='deleteparent.php?id=$row[parent_id]' data-toggle='modal' data-target='#delete_schedule'><i class='fa fa-trash-o m-r-5'></i> Delete</a>
				...
				<div class="modal-content">
					<div class="modal-body text-center">
                       ...
                       echo" <div class='m-t-20'> <a href='#' class='btn btn-white' data-dismiss='modal'>Close</a>
						<a  href='deleteparent.php?id=$row[parent_id]'>	<button type='submit' class='btn btn-danger'>Delete</button></a>
						</div>";
                        ?>
					</div>
				</div>
