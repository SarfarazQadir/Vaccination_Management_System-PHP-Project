    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-4" style="padding-left: 100px;" >Add Child Details</h1>
                    ...
                    <form method="post" >
                        <div class="row g-3">
                            <div class="col-12 col-sm-6">
                                <input type="number" name="parent_id" readonly value="<?php echo $parent['parent_id'] ?>" class="form-control border-0" placeholder="Parent ID"  style="height: 55px;">
                            </div>
                            <div class="col-12 col-sm-6">
                                <input type="text" name="child_name" class="form-control border-0" placeholder="Child Name"  style="height: 55px;">
                            </div>
                            <div class="col-12 col-sm-6">
                                <input type="date" name="date_birth" class="form-control border-0" placeholder="Date of Birth" style="height: 55px;">
                            </div>
                            <div class="col-12 col-sm-6">
                            ...
                            <div class="col-12">
                                <button name="btnchild" class="btn btn-primary w-100 py-3" type="submit">Add Child</button>
                            </div>
                        </div>
                    </form>
                    <?php
                    if(isset($_POST['btnchild'])){
                        ...
                        $query ="INSERT INTO `child_details`(`parent_id`, `name`, `date_of_birth`, `gender`) VALUES ('$parentid','$childname','$birth','$gender')";  
                        $result = mysqli_query($con, $query);
                        if($result){
                            echo"
                            <script>
			                alert('Child added Successful');
			                window.location.href ='addchild.php'
                            </script>";
                        }else{
                            echo"
                            <script>
			                alert('Child is not added Successful');
                            </script>"; 
                        }
                    }
