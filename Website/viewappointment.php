...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        ...
                        <a href="team.php" class="dropdown-item">Our Hospital</a>
    ...
    <center>
            ...
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h1 class="mb-4" style="padding-left: 100px;">View Appointment</h1>
                ...
                <table class="table" border="3">
                    ...
                    <tbody>
                    <?php
      $query ="SELECT * FROM booking_details where parent_id = $_SESSION[parent_session_id] ";
      $result=mysqli_query($con,$query);
      foreach($result as $row){
        ...
        //   echo"<td>
        //   <a href='updatechild.php?id=$row[child_id]&parentname=$row[parent_id]&name=$row[name]&date=$row[date_of_birth]&gender=$row[gender]''class='update'>UPDATE</a>
        //   </td>";
          echo"<td>
          <a href='deleteappointment.php?id=$row[booking_id]''class='delete'>DELETE</a>
          </td>";
          echo"</tr>";
      };
      ?>
