                    ...
                    <div class="bg-light rounded h-100 d-flex align-items-center p-5">
                        <form method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="text"readonly name="name" class="form-control border-0" placeholder="Your Name" value="<?php echo $parent['parent_name'] ?>" style="height: 55px;">
                                </div>
                               

                                <div class="col-12">
                                    <a href="profile.php" class="btn btn-primary w-100 py-3">Update Profile</a>
                                </div>
                            </div>
                        </form>
