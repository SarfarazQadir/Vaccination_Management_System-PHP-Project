            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        ...
                        <a href="team.php" class="dropdown-item">Our Hospitals</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-4">
                        <div class="border-start border-light ps-4">
                            ...
                            <p class="text-light mb-0">Total Hospitals</p>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="border-start border-light ps-4">
                    ...
                    <div class="col-sm-4">
                        <div class="border-start border-light ps-4">
                            ...
                            <p class="text-light mb-0">Total Vaccinated</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="owl-carousel header-carousel">
                    <div class="owl-carousel-item position-relative">
                        ...
                        <div class="owl-carousel-text">
                            <h1 class="display-1 text-white mb-0">Covid</h1>
                        </div>
                    </div>
                    <div class="owl-carousel-item position-relative">
                        <img class="img-fluid" src="img/carousel-2.jpg" alt="">
                        <div class="owl-carousel-text">
                            <h1 class="display-1 text-white mb-0">Polio</h1>
                        </div>
                    </div>
                    <div class="owl-carousel-item position-relative">
                        <img class="img-fluid" src="img/carousel-3.jpg" alt="">
                        <div class="owl-carousel-text">
                            <h1 class="display-1 text-white mb-0">Rotavirus Vaccine</h1>
                        </div>
                    </div>
                </div>
            </div>
