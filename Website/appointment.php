...
if (isset($_POST['btnappointment'])) {
    ...
    $query = "INSERT INTO `booking_details`(`child_id`, `hospital_id`, `booking_time`,`booking_date`, `vaccine_id`,`parent_id`) VALUES ('$childid','$hospital', '$time','$date','$vaccine',$parentid)";
    $result = mysqli_query($con, $query);
    if ($result) {
        echo "
                                <script>
        ...
        echo "
                                <script>
                                alert('Appointment is not Booked Successful');
                                </script>";
    }
}
?>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                if (isset($_SESSION['parent_session'])) {
                    ...
                    <a href='profile.php' class='nav-link dropdown-toggle'>$_SESSION[parent_session]</a>
                    <div class='dropdown-menu rounded-0 rounded-bottom m-0'>
                        ...
                        <form method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="number" class="form-control border-0" name="parentid" placeholder="Your  ID" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="number" class="form-control border-0" name="childid" placeholder="Your Child ID" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <select name="hospital_name" class="form-select border-0" style="height: 55px;">
                                        <option hidden>Choose any Hospital</option>
                                        <?php
                                ...
                                <div class="col-12 col-sm-6">
                                    <select name="time" class="form-select border-0" style="height: 55px;">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="date" class="form-control border-0" name="date" placeholder="Booking Date" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <select name="vaccinename" class="form-select border-0" style="height: 55px;">
                                        <option hidden>Choose Your Vaccine</option>
                                        <?php
                                        $query = "SELECT * FROM vaccine_details where vaccine_availability = 'available' ";
                                        $result = mysqli_query($con, $query);
                                        foreach ($result as $row) {
                                ...
                                <div class="col-12">
                                    <button name="btnappointment" class="btn btn-primary w-100 py-3" type="submit">Book Appointment</button>
                                </div>
                            </div>
                        </form>
