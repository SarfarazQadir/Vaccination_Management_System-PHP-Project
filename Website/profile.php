...
$query = "SELECT * FROM parent_details WHERE parent_id = $_SESSION[parent_session_id]  ";
            ...
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h1 class="mb-4" style="padding-left: 100px;">My Profile</h1>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-light rounded h-100 d-flex align-items-center p-5">
                        <form method="post">
                            <div class="row g-3">
                                <div class="col-12 col-sm-6">
                                    <input type="text" readonly name="name" class="form-control border-0" placeholder="Your Name" value="<?php echo $parent['parent_id'] ?>" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="name" class="form-control border-0" placeholder="Your Name" value="<?php echo $parent['parent_name'] ?>" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="username" class="form-control border-0" placeholder="Your Username" value="<?php echo $parent['parent_username']; ?>" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="password" name="password" class="form-control border-0" placeholder="Your Password" value="<?php echo $parent['parent_password']; ?>" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="email" name="email" class="form-control border-0" placeholder="Your Email" value="<?php echo $parent['parent_email']; ?>" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="contact" class="form-control border-0" placeholder="Your Mobile" value="<?php echo $parent['parent_contact']; ?>" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="city" class="form-control border-0" placeholder="Your City" value="<?php echo $parent['parent_city']; ?>" style="height: 55px;">
                                </div>
                        ...
                        if (isset($_POST['btnupdate'])) {
                            ...
                            $query1 = "UPDATE `parent_details` SET `parent_name`='$name',`parent_username`='$username',`parent_password`='$password',`parent_email`='$email',`parent_contact`= $contact ,`parent_city`='$city' WHERE parent_id = $_SESSION[parent_session_id]";
