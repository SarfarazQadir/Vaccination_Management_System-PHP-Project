...
<body>
    ...
    <center>
            ...
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h1 class="mb-4" style="padding-left: 100px;">Child Details</h1>
                ...
                <table class="table" border="3">
                    ...
                    <tbody>
                    <?php
      $query ="SELECT * FROM child_details WHERE parent_id= $_SESSION[parent_session_id]";
      $result=mysqli_query($con,$query);
      foreach($result as $row){
          ...
          echo"<td>
          <a href='deletechild.php?id=$row[child_id]''class='delete'>DELETE</a>
          </td>";
          echo"</tr>";
      };
      ?>
