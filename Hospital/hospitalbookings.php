...
<body>
    <div class="main-wrapper">
        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-12">
                    <h4 style="text-align: center;margin-bottom: 90px;" class="page-title">BOOKING DETAILS</h4>
                </div>
            </div>
            <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 style="text-align: center;" class="page-title">BOOKING DETAILS</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                <table class="datatable table table-stripped dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $query = "SELECT * FROM `booking_details` JOIN hospital_details on booking_details.hospital_id = hospital_details.hospital_id JOIN child_details on booking_details.child_id = child_details.child_id WHERE booking_details.hospital_id = $_SESSION[id] && booking_details.b_status = 'Approve'";
                                                        $result = mysqli_query($con, $query);
                                                        $count = mysqli_num_rows($result);
                                                        if ($count >= 1) {
                                                            foreach ($result as $row1) {
                                                                echo "<tr>";
                                                               // echo "<td>$row1[booking_id]</td>";
                                                                echo "<td>$row1[name]</td>";
                                                                echo "<td>$row1[hospital_name]</td>";
                                                                echo "<td>$row1[booking_date]</td>";
                                                                echo "<td>$row1[booking_time]</td>";
                                                                echo"<td>
                                                                <a href='report.php?id=$row1[booking_id]&cid=$row1[child_id]&hid=$row1[hospital_id]&time=$row1[booking_time]&date=$row1[booking_date]&vid=$row1[vaccine_id]&report=$row1[Report]'>VIEW REPORT</a></td>";
                                                                echo "</tr>";
                                                            };
                                                        } else {
